...
// `canManageTeam`, `canEditAvailability` and `availabilityOverride` used to
// live here. They are now `mayManageTeam`, `mayAnswerFor` and `answerOverride`
// in `@shared/lib/teamAuthority` (#569) — one copy for this app, the web and
// the API, which had none at all and refused nothing.
