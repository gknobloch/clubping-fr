...
import { formatAddress } from './club'

// ---------------------------------------------------------------------------
// Calendar helpers (#416) — turning a game into the event we hand to the OS's
// own "new event" screen. Pure on purpose: the expo-calendar call lives in the
// match screen, everything that decides *what* the event says lives here, where
// it can be tested without a native module.
// ---------------------------------------------------------------------------
