...
INSERT INTO teams (id, club_id, phase_id, number, group_id, game_location_id, default_day, default_time, captain_id, player_ids, color, whatsapp_link, is_archived) VALUES
  ('team-1', 'club-fftt-06680011', 'phase-26-1', 1, 'group-1', 'addr-1', 'Samedi', '16h00', 'p2-player-5', '["p2-player-5","p2-player-1","p2-player-2","p2-player-3","p2-player-4"]', '#374151', NULL, 0),
  ('team-2', 'club-fftt-06680011', 'phase-26-1', 2, 'group-2', 'addr-1', 'Samedi', '16h00', 'p2-player-6', '["p2-player-6","p2-player-10","p2-player-7","p2-player-9","p2-player-8"]', '#b91c1c', NULL, 0),
  ('team-3', 'club-fftt-06680011', 'phase-26-1', 3, 'group-3', 'addr-1', 'Samedi', '16h00', 'p2-player-12', '["p2-player-12","p2-player-13","p2-player-14","p2-player-11","p2-player-17"]', '#15803d', NULL, 0),
  ('team-4', 'club-fftt-06680011', 'phase-26-1', 4, 'group-4', 'addr-1', 'Jeudi', '20h00', 'p2-player-16', '["p2-player-16","p2-player-19","p2-player-18","p2-player-15","p2-player-20"]', '#c2410c', NULL, 0),
  ('team-5', 'club-fftt-06680011', 'phase-26-1', 5, 'group-5', 'addr-1', 'Samedi', '16h00', 'p2-player-23', '["p2-player-22","p2-player-24","p2-player-21","p2-player-23","p2-player-26"]', '#1d4ed8', NULL, 0),
  ('team-6', 'club-fftt-06680011', 'phase-26-1', 6, 'group-5', 'addr-2', 'Samedi', '16h00', 'p2-player-42', '["p2-player-29","p2-player-39","p2-player-40","p2-player-41","p2-player-42","p2-player-38","p2-player-43","p2-player-44"]', '#be185d', NULL, 0),
  ('team-7', 'club-fftt-06680011', 'phase-26-1', 7, 'group-6', 'addr-1', 'Jeudi', '20h00', 'p2-player-33', '["p2-player-33","p2-player-35","p2-player-34","p2-player-36","p2-player-37"]', '#7c2d12', NULL, 0),
  ('team-8', 'club-fftt-06680011', 'phase-26-1', 8, 'group-7', 'addr-1', 'Jeudi', '20h00', 'p2-player-32', '["p2-player-32","p2-player-27","p2-player-28","p2-player-30","p2-player-31"]', '#0d9488', NULL, 0);

-- teams (opponents)
-- division_id dropped in 0031 (#282): the group holds the division.
INSERT INTO teams (id, club_id, phase_id, number, group_id, game_location_id, default_day, default_time, captain_id, player_ids, color, whatsapp_link, is_archived) VALUES
  ('opp-etival-1', 'club-fftt-06880123', 'phase-26-1', 1, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-rosenau-1', 'club-fftt-06680125', 'phase-26-1', 1, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-rcs-2', 'club-fftt-06670045', 'phase-26-1', 2, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-vittel-1', 'club-fftt-06880022', 'phase-26-1', 1, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-2', 'club-fftt-06680091', 'phase-26-1', 2, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-moussey-1', 'club-fftt-06100004', 'phase-26-1', 1, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-anould-2', 'club-fftt-06880002', 'phase-26-1', 2, 'group-1', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-3', 'club-fftt-06680091', 'phase-26-1', 3, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-rosenau-2', 'club-fftt-06680125', 'phase-26-1', 2, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-cmjc-3', 'club-fftt-06680004', 'phase-26-1', 3, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-caje-1', 'club-fftt-06680080', 'phase-26-1', 1, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-stlouis-1', 'club-fftt-06680082', 'phase-26-1', 1, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-huningue-1', 'club-fftt-06680102', 'phase-26-1', 1, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-ingersheim-1', 'club-fftt-06680090', 'phase-26-1', 1, 'group-2', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-issenheim-1', 'club-fftt-06680071', 'phase-26-1', 1, 'group-3', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-6', 'club-fftt-06680091', 'phase-26-1', 6, 'group-3', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-wintzfelden-2', 'club-fftt-06680116', 'phase-26-1', 2, 'group-3', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-huningue-2', 'club-fftt-06680102', 'phase-26-1', 2, 'group-3', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-thann-2', 'club-fftt-06680111', 'phase-26-1', 2, 'group-3', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-rosenau-4', 'club-fftt-06680125', 'phase-26-1', 4, 'group-3', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-soultz-2', 'club-fftt-06680138', 'phase-26-1', 2, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-wittelsheim-5', 'club-fftt-06680118', 'phase-26-1', 5, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-8', 'club-fftt-06680091', 'phase-26-1', 8, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-fcm-3', 'club-fftt-06680006', 'phase-26-1', 3, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-kembs-2', 'club-fftt-06680140', 'phase-26-1', 2, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-ensisheim-1', 'club-fftt-06680123', 'phase-26-1', 1, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-rosenau-6', 'club-fftt-06680125', 'phase-26-1', 6, 'group-4', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-issenheim-3', 'club-fftt-06680071', 'phase-26-1', 3, 'group-5', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-7', 'club-fftt-06680091', 'phase-26-1', 7, 'group-5', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-ballons-4', 'club-fftt-06880064', 'phase-26-1', 4, 'group-5', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-mutt-5', 'club-fftt-06680105', 'phase-26-1', 5, 'group-5', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-wittelsheim-4', 'club-fftt-06680118', 'phase-26-1', 4, 'group-5', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-wintzfelden-3', 'club-fftt-06680116', 'phase-26-1', 3, 'group-5', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-huningue-3', 'club-fftt-06680102', 'phase-26-1', 3, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-mutt-7', 'club-fftt-06680105', 'phase-26-1', 7, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-thann-5', 'club-fftt-06680111', 'phase-26-1', 5, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-stlouis-3', 'club-fftt-06680082', 'phase-26-1', 3, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-kembs-3', 'club-fftt-06680140', 'phase-26-1', 3, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-10', 'club-fftt-06680091', 'phase-26-1', 10, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-soultz-4', 'club-fftt-06680138', 'phase-26-1', 4, 'group-6', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-rosenau-7', 'club-fftt-06680125', 'phase-26-1', 7, 'group-7', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-thann-4', 'club-fftt-06680111', 'phase-26-1', 4, 'group-7', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-issenheim-4', 'club-fftt-06680071', 'phase-26-1', 4, 'group-7', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-huningue-4', 'club-fftt-06680102', 'phase-26-1', 4, 'group-7', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-kembs-6', 'club-fftt-06680140', 'phase-26-1', 6, 'group-7', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-kembs-4', 'club-fftt-06680140', 'phase-26-1', 4, 'group-7', '', '', '', '', '[]', NULL, NULL, 0),
  ('opp-illzach-11', 'club-fftt-06680091', 'phase-26-1', 11, 'group-7', '', '', '', '', '[]', NULL, NULL, 0);

-- player points per phase (#384) — moved off teams.roster_initial_points
INSERT INTO player_phase_points (phase_id, player_id, points) VALUES
  ('phase-26-1', 'p2-player-5', '1887'),
  ('phase-26-1', 'p2-player-1', '1763'),
  ('phase-26-1', 'p2-player-2', '1665'),
  ('phase-26-1', 'p2-player-3', '1647'),
  ('phase-26-1', 'p2-player-4', '1566'),
  ('phase-26-1', 'p2-player-6', '1791'),
  ('phase-26-1', 'p2-player-10', '1661'),
  ('phase-26-1', 'p2-player-7', '1500'),
  ('phase-26-1', 'p2-player-9', '1301'),
  ('phase-26-1', 'p2-player-8', '1301'),
  ('phase-26-1', 'p2-player-12', '1356'),
  ('phase-26-1', 'p2-player-13', '1267'),
  ('phase-26-1', 'p2-player-14', '1198'),
  ('phase-26-1', 'p2-player-11', '1186'),
  ('phase-26-1', 'p2-player-17', '754'),
  ('phase-26-1', 'p2-player-16', '889'),
  ('phase-26-1', 'p2-player-19', '728'),
  ('phase-26-1', 'p2-player-18', '727'),
  ('phase-26-1', 'p2-player-15', '713'),
  ('phase-26-1', 'p2-player-20', '704'),
  ('phase-26-1', 'p2-player-22', '735'),
  ('phase-26-1', 'p2-player-24', '701'),
  ('phase-26-1', 'p2-player-21', '702'),
  ('phase-26-1', 'p2-player-23', '1050'),
  ('phase-26-1', 'p2-player-26', '707'),
  ('phase-26-1', 'p2-player-29', '632'),
  ('phase-26-1', 'p2-player-39', '500'),
  ('phase-26-1', 'p2-player-40', '503'),
  ('phase-26-1', 'p2-player-41', '561'),
  ('phase-26-1', 'p2-player-42', '500'),
  ('phase-26-1', 'p2-player-38', '500'),
  ('phase-26-1', 'p2-player-43', '500'),
  ('phase-26-1', 'p2-player-44', '500'),
  ('phase-26-1', 'p2-player-33', '500'),
  ('phase-26-1', 'p2-player-35', '500'),
  ('phase-26-1', 'p2-player-34', '500'),
  ('phase-26-1', 'p2-player-36', '500'),
  ('phase-26-1', 'p2-player-37', '500'),
  ('phase-26-1', 'p2-player-32', '607'),
  ('phase-26-1', 'p2-player-27', '501'),
  ('phase-26-1', 'p2-player-28', '500'),
  ('phase-26-1', 'p2-player-30', '500'),
  ('phase-26-1', 'p2-player-31', '500');
